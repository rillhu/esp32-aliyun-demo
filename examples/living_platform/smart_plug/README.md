...
Using gpio 2 to control the switch:

```
{"PowerSwitch":0} --> gpio2 = 0
{"PowerSwitch":1} --> gpio2 = 1
```
...
```
$IDF_PATH/components/nvs_flash/nvs_partition_generator/nvs_partition_gen.py --input myesp32plug_single_mfg_config.csv --output myesp32plug_single_mfg_config.bin --size 0x4000 $IDF_PATH/components/esptool_py/esptool/esptool.py --port COM17 write_flash 0x210000 myesp32plug_single_mfg_config.bin
```
